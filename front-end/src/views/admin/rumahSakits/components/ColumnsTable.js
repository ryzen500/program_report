...
export default function ColumnsTable(props) {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await axios.get('http://localhost/program_report/back-end/index.php/api/hak_akses');
  ...
  const handleEditClick = async (row) => {
    console.log("Edit clicked for row:", row.hak_akses_id);
    try {
      const response = await axios.get(
        `http://localhost/program_report/back-end/index.php/api/hak_akses/${row.hak_akses_id}`
      );
