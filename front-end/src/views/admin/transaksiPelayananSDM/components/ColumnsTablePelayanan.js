...
export default function ColumnsTable(props) {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await axios.get('http://localhost/program_report/back-end/index.php/api/submaster_pelayanan');
  ...
  const handleEditClick = async (row) => {
    ...
    try {
      const response = await axios.get(
        `http://localhost/program_report/back-end/index.php/api/submaster_pelayanan/${row.subpelayanan_id}`
      );
